    ...
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center bg-[#050505] px-4 selection:bg-amber-500/20">
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <p className="text-2xl font-bold text-zinc-100 tracking-tight">Create your workstation account</p>
          <p className="text-xs text-zinc-500">Access AI-powered blueprint-to-CAD generators</p>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-800/80 bg-zinc-900/40 p-8 shadow-2xl backdrop-blur-xl">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label htmlFor="signup-email" className="text-xs font-semibold text-zinc-400">
                Email Address
              </label>
            ...
            <div className="space-y-2">
              <label htmlFor="signup-password" className="text-xs font-semibold text-zinc-400">
                Password
              </label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-zinc-600">
            ...
            <div className="space-y-2">
              <label htmlFor="signup-confirm-password" className="text-xs font-semibold text-zinc-400">
                Confirm Password
              </label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-zinc-600">
